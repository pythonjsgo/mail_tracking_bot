...
class DB_manager:
    def __init__(self):
        ...
        self.sql.execute("CREATE TABLE IF NOT EXISTS departures (user_id TEXT, departure_id TEXT, departure_data TEXT)")
        self.db.commit()
    ...
    def add_user_departures(self, user_id, departure_id, data="None"):
        self.sql.execute(f"INSERT INTO departures VALUES  ('{user_id}', '{departure_id}', '{data}')")
        self.db.commit()
